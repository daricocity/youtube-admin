...
const UserList = () => {
    ...
    return (
        <MainCard title="Users">
            <UserTable data={users} handleDelete={handleDelete} isLoading={isLoading} />
        </MainCard>
    );
};
