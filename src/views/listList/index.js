                                        ...
                                        .map((row, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="center">{row.content.length} Movies</TableCell>
                                                    <TableCell align="center">
                                                        <Link to={{ pathname: '/list/' + row._id }} state={{ list: row }}>
                                                            <Fab
                                                                color="secondary"
                                                                aria-label="delete"
                                                                size="small"
...
const ListList = () => {
    ...
    return (
        <MainCard title="List" button listListSection>
            <ListTable data={lists} handleDelete={handleDelete} isLoading={isLoading} />
        </MainCard>
    );
};
